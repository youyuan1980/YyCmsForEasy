...
<head>
    <meta charset="UTF-8">
    <title>无标题页</title>
    <link href="/yycms/Public/Css/css.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/yycms/Public/script/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="/yycms/Public/script/Common.js"></script>
    <script type="text/javascript" charset="utf-8" src="/yycms/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/yycms/Public/ueditor/ueditor.all.js"> </script>
    <script type="text/javascript" charset="utf-8" src="/yycms/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
    <script>
		function cl_Click () {
    ...
    <form id="form1" method="post" action="<?php echo ($actionurl); ?>">
        <div>
            ...
            <div class="PageToolBar" id="PageToolBar">
                <img src="/yycms/Public/Images/add.gif" /><a id="c1" href="#" onclick="cl_Click();">保存</a>
            </div>
            <div id="container">
                <div id="content">
